export const navLinks = [
  ...
  export const workExperiences = [
...

    {
      ...
      title: "Developed a responsive e-commerce platform with React.js, Node.js, and Tailwind CSS, increasing mobile conversions by 35% and handling 1,000+ daily users. Built a scalable SaaS analytics dashboard with MERN stack, Flask microservices, and AWS deployment, enhancing real-time tracking and client satisfaction. Implemented JWT-based security, role-based access control, and PostgreSQL, achieving 99.9% uptime and reducing cart abandonment. Designed MongoDB and SQL architectures, created RESTful and SOAP APIs, and integrated Jest testing for faster data processing. Streamlined CI/CD with Git, GitHub, and Kubernetes, improving deployment time and code quality in an Agile environment.",
    ...
    },
    {
      ...
      title: "Developed an EHR system with the MERN stack and Redux, achieving 95% positive feedback through AWS-deployed, staff-driven iterations. Created a TypeScript-based patient portal with React.js, GraphQL, and AWS, ensuring 99.9% uptime with Docker. Architected PostgreSQL schemas and RESTful APIs, integrated Redis for performance, and enhanced security with Cypress testing. Led healthcare app development using React.js, Django, and CI/CD pipelines, boosting user experience with automated scheduling and telemedicine. Built cross-platform solutions using React Native, Vue.js, and Firebase, collaborating in Agile teams for high-performance results. Enhanced real-time communication with WebSocket integration and streamlined payment processing through secure gateway integration, driving user satisfaction.",
